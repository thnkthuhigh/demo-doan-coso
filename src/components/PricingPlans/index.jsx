  ...
  return (
    ...
    >
      ...
      <motion.div variants={itemVariants} className="mb-12">
        <div className="bg-white/90 backdrop-blur-sm rounded-2xl p-2 shadow-soft border border-vintage-gold/20 max-w-2xl mx-auto">
        ...
        {getFilteredPlans().map((plan, index) => {
          ...
          return (
            <motion.div
              ...
              className={`relative bg-white rounded-2xl shadow-elegant overflow-hidden border-2 transition-all duration-500 ${
                isSelected
                  ? `border-vintage-gold shadow-golden`
                  : "border-transparent hover:border-vintage-gold/50"
            ...
            >
              ...
              {isPopular && (
                <div className="absolute top-0 left-0 right-0 z-10">
                  <div
                    className={`bg-gradient-luxury text-white text-center py-2 font-semibold relative overflow-hidden`}
                  >
              ...
              >
                <div className="text-center">
                  ...
                  <div className="flex items-baseline justify-center mb-2">
                    <span className="text-4xl font-extrabold text-vintage-dark">
                      {formatPrice(plan.price)}
                    </span>
                    <span className="text-lg text-vintage-neutral ml-1">đ</span>
                  </div>
              ...
              <div className="p-8 space-y-6">
                ...
                <ul className="space-y-4">
                  {plan.features.map((feature, featureIndex) => (
                    ...
                    >
                      ...
                      <span className="text-vintage-neutral leading-relaxed">
                        {feature}
                      </span>
                    </motion.li>
                  ))}
                ...
                {/* Plan Stats */}
                <div className="grid grid-cols-2 gap-4 pt-4 border-t border-vintage-gold/20">
                  <div className="text-center">
                    <div
                  ...
                  <div className="text-center">
                    ...
                    <div className="text-xs text-vintage-neutral">/ tháng</div>
                  </div>
                </div>
                  ...
                  <div className="pt-2">
                    {plan.type !== "Platinum" ? (
                      ...
                      <motion.button
                        ...
                        className="w-full py-4 px-6 rounded-xl font-semibold transition-all duration-300 bg-gradient-to-r from-amber-500 to-amber-600 hover:from-amber-600 hover:to-amber-700 text-white shadow-lg hover:shadow-xl group relative overflow-hidden"
                      >
                        <div className="relative z-10 flex items-center justify-center space-x-2">
                ...
                <div className="pt-4 border-t border-vintage-gold/20">
                  <div className="flex items-center justify-center space-x-4 text-xs text-vintage-neutral">
              ...
              {isSelected && (
                <motion.div
                  initial={{ scale: 0 }}
                  animate={{ scale: 1 }}
                  className="absolute top-4 right-4 w-8 h-8 bg-vintage-gold rounded-full flex items-center justify-center shadow-golden"
                >
      ...
      <motion.div
        variants={itemVariants}
        className="bg-white/90 backdrop-blur-sm rounded-2xl p-8 shadow-soft border border-vintage-gold/20"
      >
        <div className="text-center mb-8">
          <h3 className="text-2xl font-bold text-vintage-dark mb-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {[
            ...
            <motion.div
              ...
              className="text-center p-6 rounded-xl bg-vintage-warm hover:bg-white hover:shadow-soft transition-all duration-300"
            >
              <div
              ...
              <h4 className="text-lg font-semibold text-vintage-dark mb-2">
                {feature.title}
              </h4>
              <p className="text-vintage-neutral text-sm leading-relaxed">
                {feature.description}
              </p>
            </motion.div>
          ))}
